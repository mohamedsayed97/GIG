...
{
    public class UploadAdditionsViewModel
    {
        ...
        //[Remote("IsAlreadyPriced", "Subscription", HttpMethod = "POST", AdditionalFields = "processingDate , FundId", ErrorMessage = "There is no price for this data.")]
